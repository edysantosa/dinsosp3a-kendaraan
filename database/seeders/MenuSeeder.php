...
class MenuSeeder extends Seeder
{
    ...
    {
        $menus = [
            ['menu_title' => 'Dashboard', 'parent_id' => 0, 'sort_order' => 0, 'slug' => '/', 'icon' => 'icon-speedometer'],
            ['menu_title' => 'Pages', 'parent_id' => 0, 'sort_order' => 1, 'slug' => '/pages', 'icon' => 'icon-options-vertical'],
