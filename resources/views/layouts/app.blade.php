                    ...
                    <nav class="xp-horizontal-nav xp-mobile-navbar xp-fixed-navbar">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-menu">
                          <ul class="xp-horizontal-menu">
                            ...
                            <li class="scroll"><a href="index.html"><i class="icon-speedometer"></i><span>Dashboard</span></a></li>
                            ...
                            <li class="scroll"><a href="events.html"><i class="icon-event"></i><span>Events</span></a></li>
                            <li class="dropdown menu-item-has-mega-menu">
